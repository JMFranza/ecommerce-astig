...
const VerificationUser = () => {
  ...
  const handleSubmit = async () => {
    ...
    const data = await forms.user_account_verification(token);
          ...
          <div className="absolute">
            <div className="">
              ...
              <p className="my-2 text-gray-800">
                Click the button below to verify your email. Thank you for
                signing up. I hope you fun and and Wish you luck!
              </p>
              <button
